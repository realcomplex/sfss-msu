...
\newfontfamily\titlefont{Niconne}

% Ornaments: download 'http://altermundus.com/pages/tkz/ornament/index.html'
...
\fancyfoot[L]{\footnotesize Koen van Greevenbroek (\texttt{math-pres@sfu.ca})}
\fancyfoot[C]{}
\fancyfoot[R]{\raisebox{-0.5\height}{\includegraphics[scale=0.35]{SFSS_logo_small.jpg}}}
...
\begin{center}
  ...
  \vfill
  \pgfornament[width=6cm,color=black]{88}
  \vfill
\end{center}
